...
function mapSettings(data: Record<string, unknown>): SiteSettings {
  return {
    ...
    company_address: (data.company_address as string | null) ?? null,
    company_registration_number: (data.company_registration_number as string | null) ?? null,
...
export async function PATCH(request: Request) {
  ...
  const payload = {
    ...
    company_registration_number: body.company_registration_number?.trim() || null,
